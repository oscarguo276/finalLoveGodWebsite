<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<!-- Bootstrap Core Css-->
			<link href="${contextRoot}/vender/bootstrap/4.6.2/bootstrap_Modal.css" rel="stylesheet" />
				...
				<div class="container px-4 px-lg-8">
					...
					<div class="collapse navbar-collapse" id="navbarResponsive">
						<ul class="navbar-nav ms-auto my-2 my-lg-0">
							...
							<li class="nav-item"><a class="nav-link" href="${contextRoot}/drawlots">求籤</a></li>
							<li class="nav-item"><a class="nav-link" href="${contextRoot}/marriage">求姻緣</a></li>
							<li class="nav-item"><a class="nav-link" href="${contextRoot}/shop">線上商城</a></li>
							<li class="nav-item"><a class="nav-link" href="${contextRoot}/about">關於月老</a></li>
							<li class="nav-item"><a class="nav-link"
									href="${contextRoot}/management/allManagement">後台管理</a>
							</li>
							<!--      -------------------------------------------------------------------------- -->
							<li class="nav-item"><a class="nav-link" href="${contextRoot}/newProducts">新增商品</a></li>
							<!--       -------------------------------------------------------------------------- -->
							<li class="nav-item">
								<c:choose>
									<c:when test="${empty memberId}">
							<li class="nav-item"><a class="nav-link" href="${contextRoot}/login"> 訪客 </a></li>
							</c:when>
							<c:otherwise>
								<li class="nav-item"><a class="nav-link" href="${contextRoot}/management/allManagement">
										使用者${memberId} </a></li>
