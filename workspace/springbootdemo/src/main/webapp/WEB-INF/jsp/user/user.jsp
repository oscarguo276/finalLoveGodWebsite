			...
			<div class="my-5 col-lg-6">
				<div class="card-body p-0">
					...
					<div class="p-5 row">
						...
						<div
							class="form-check col-lg-10 h2 text-gray-900 mb-4">
						...
						<div id="extraData" style="display: none;">
							...
							<div class="form-group col-lg-12">
								...
								<textarea class="form-control"
									id="exampleFormControlTextarea1" rows="5" name="text"></textarea>
							</div>
							<div class="form-group col-lg-12">
							...
							<div class="form-group col-lg-12"
								...
								<div class="form-check">
									<input class="form-check-input" type="radio" name="Line"
										...
										class="form-check-label" for="contactRadio2">
										Line： </label>
								</div>
							</div>
							<div class="form-group col-lg-12">
							...
							<div class="form-group col-lg-12"
								...
								<div class="form-check">
									<input class="form-check-input" type="radio" name="IG"
										...
										class="form-check-label" for="contactRadio3">
										IG： </label>
								</div>
							</div>
							<div class="form-group col-lg-12">
						...
						<button
							class=" btn-loginColor btn-block btn-lg font"
